    ...
    try {
      ...
      const { data: bookingData, error: bookingError } = await supabase.functions.invoke("create-booking", {
        body: {
          ...
          organizerFee: data.organizerFee || 0,
        },
      });
      ...
      <div className="pb-32">
        ...
        {court && selectedSlots.length > 0 && selectedDate && !isQuickGameMode && (
          <BookingWizard
            ...
            allowedSports={getSelectedCourt()?.allowed_sports || court.allowed_sports || []}
            ...
            courtName={getSelectedCourt()?.name || court.name}
            venueName={court.venues?.name || ""}
            venueAddress={court.venues?.address || ""}
            courtRules={getSelectedCourt()?.rules || (court as any).rules || null}
