  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-20">
          ...
          <div className="mx-auto grid max-w-7xl min-[1600px]:max-w-[1500px] min-[1920px]:max-w-[1700px] items-center gap-6 lg:grid-cols-2 lg:gap-8 xl:gap-10 min-[1600px]:gap-16 w-full">
            ...
            <div className="relative hidden lg:block">
              <div className="relative aspect-[16/9] xl:aspect-[4/3] min-[1600px]:aspect-square min-[1920px]:aspect-[4/5] overflow-hidden rounded-[3rem] border-8 border-card shadow-2xl">
                <img src="/homeCourt.webp" alt="Sport court" className="h-full w-full object-cover" width={1024} height={682} fetchPriority="high" />
        ...
        <section className="py-8" style={{ WebkitTransform: 'translateZ(0)', transform: 'translateZ(0)' }}>
          <div className="relative overflow-hidden bg-primary px-6 py-8 text-center text-primary-foreground shadow-2xl shadow-primary/25 md:px-10 md:py-12" style={{ WebkitTransform: 'translateZ(0)', transform: 'translateZ(0)' }}>
          ...
          <div className="mb-20 grid gap-12 md:grid-cols-4">
            <div className="md:col-span-2">
              <Link to="/" className="mb-0 flex items-center gap-3 leading-none" aria-label="Sport Arena home">
                <img src="/sportarena-logo.webp" alt="Sport Arena logo" className="block h-14 w-auto object-contain" />
              </Link>
