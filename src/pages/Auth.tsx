                ...
                <TabsContent value="login">
                  <Form {...loginForm}>
                    ...
                    <p className="text-xs text-amber-600 dark:text-amber-400">
                      ...
                      <Button type="button" variant="outline" className="w-full" onClick={handleAppleSignIn} disabled={isSubmitting || isGoogleLoading || isAppleLoading}>
                        {isAppleLoading ? <Loader2 className="h-4 w-4 animate-spin mr-2" /> :
